...
Usage:
  python wsi_residual_debug.py --image paper/L0-1024.jpg --out debug_output --tile 256 --resq 75
...
Compression:
  ...
  For each L1 tile (2x2 grid):
    ...
    015_L1_{x}_{y}_residual_raw.png - Raw residual (Y_gt - Y_pred)
...
def compress_with_debug(l2_tile, l1_tiles, l0_tiles, out_dir, tile_size=256,
    ...
    # Save the upsampled L2 tile (Stage C output)
    save_debug_image(l1_pred, out_dir / "compress", 5, "L2_0_0_upsampled.png")
