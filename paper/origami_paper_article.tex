...
\title{ORIGAMI: Efficient Whole-Slide Image Serving Through\\Optimized Residual Image Generation Across Multiscale Interpolation}

\author{\textbf{Andrew Luetgers}\\
{\small Email: andrew.luetgers@gmail.com}
}
...
\textbf{ORIGAMI} & \textbf{8.0} & \textbf{49.8} & \textbf{0.98} & \textbf{3.1$\times$} & \textbf{$\sim$25$\times$} \\
JPEG Q60* & 3.2 & 57.9 & 0.996 & 7.8$\times$ & $\sim$61$\times$ \\
\bottomrule
\multicolumn{6}{l}{*Recompressed from Q90}
\end{tabular}%
}
\end{table}
